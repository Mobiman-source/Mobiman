...
#include "../../../ue_monitor/ue_monitor.h"
...
bool ue_context_setup_procedure::find_or_create_f1ap_ue_context()
{
  ...
  // Record new cu_ue_f1ap_id so ue_monitor reflects the updated ID after handover.
  ue_monitor::record_cu_f1ap_id(static_cast<uint64_t>(request.ue_index),
                                gnb_cu_ue_f1ap_id_to_uint(tmp_cu_ue_f1ap_id));
