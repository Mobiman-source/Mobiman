...
def get_config():
    ...
    parser.add_argument("--user_name", type=str, default='your-wandb-entity', help="[for wandb usage], wandb entity (team name).")
    parser.add_argument("--use_wandb", action='store_true', default=False, help="[for wandb usage], by default False, will use tensorboard. Pass --use_wandb to enable wandb logging.")
